...
import { delete_employee } from '../../Redux/Slice/Employee/Edit';
...
const EmployeeDetails = () => {
    ...
    const SearchByname = () => {
        dispatch(getall_employee({ search: searchTerm }))
    }
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                <select
                                    ...
                                    onChange={(e) => { setDepartmentFilter(e.target.value), dispatch(getall_employee({ department: e.target.value })) }}
                                >
                            ...
                            <div>
                                <select
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    value={statusFilter}
                                    onChange={(e) => {dispatch(getall_employee({status:e.target.value})),setStatusFilter(e.target.value)}}
                                >
