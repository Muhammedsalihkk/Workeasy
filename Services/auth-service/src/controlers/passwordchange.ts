...
export const changeapssword = async(req: AuthRequest, res: Response, next: NextFunction) => {
    try {
...
export const verify_otp = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        const id = req.user.user_id
...
export const change_password=async (req: AuthRequest, res: Response, next: NextFunction)  =>{
          try { 
